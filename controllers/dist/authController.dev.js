...
var _require2 = require("punycode"),
...
var createSendToken = function createSendToken(user, statusCode, res) {
  ...
  res.cookie("jwt", token, cookieOptions); // remove the password from output
  ...
  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 13:
          console.log(user); // 3) if everything ok, send token to client
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return _context3.abrupt("return", next(new AppError("You are not logged in! Please logged in to get access", 401)));
        ...
        case 8:
          ...
          return _context3.abrupt("return", next(new AppError("The user belonging to this token does not longer exists.", 401)));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          return _context5.abrupt("return", next(new AppError("There is no user with this email address", 404)));
